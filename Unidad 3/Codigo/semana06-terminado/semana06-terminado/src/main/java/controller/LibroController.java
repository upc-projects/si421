...
public class LibroController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		if(request.getParameter("accion") != null) {
			if(request.getParameter("accion").equals("agregar")) {
				...
				boolean flag = serviceLibro.eliminar(Integer.parseInt(Libro));
			...
			List<Libro> libros = serviceLibro.listar();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		serviceLibro = new LibroServiceImpl();
		boolean flag = serviceLibro.agregar(obj);
