...
public class LibroController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(request.getParameter("accion")!=null) {
			...
			}else if(request.getParameter("accion").equals("caro")) {
				
				
				request.setAttribute("libro", service.buscarMasCaro());
				request.getRequestDispatcher("/libro_criterio.jsp").forward(request, response);
			}else if(request.getParameter("accion").equals("barato")) {
				
				request.setAttribute("libro", service.buscarMasBarato());
				request.getRequestDispatcher("/libro_criterio.jsp").forward(request, response);
			}
		}else {
